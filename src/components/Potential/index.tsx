        ...
        <div className="potential__wrapper">
          ...
          <div className="potential-box__one">
            <m.div
              ...
              transition={{ duration: 1, ease: "easeInOut", delay: 0 * animationDelay }}
            ...
            >
              ...
              <div className="potential-box__item-content one">
                ...
                <p>
                  Minimize model response time with our <span>160+ location CDN</span>, providing an average global
                  latency of 30 ms.
                </p>
              </div>
            </m.div>
          ...
          <div className="potential-box__two">
            <m.div
              initial={{ y: 100, opacity: 0 }}
              whileInView={{ y: 0, opacity: 1 }}
              transition={{ duration: 1, ease: "easeInOut", delay: 2 * animationDelay }}
              className="potential-box__item"
            >
              <video
                className=""
            ...
            <m.div
              initial={{ y: 100, opacity: 0 }}
              whileInView={{ y: 0, opacity: 1 }}
              transition={{ duration: 1, ease: "easeInOut", delay: 3 * animationDelay }}
              className="potential-box__item"
            >
              <video
                className=""
            ...
            <m.div
              initial={{ y: 100, opacity: 0 }}
              whileInView={{ y: 0, opacity: 1 }}
              transition={{ duration: 1, ease: "easeInOut", delay: 4 * animationDelay }}
              className="potential-box__item"
            >
              <video
                className=""
              ...
              <div className="potential-box__item-content">
                ...
                <p>
                  Use pre-trained foundational models from the <span>Gcore ML Model Hub</span> or your own trained models.
                </p>
              </div>
            </m.div>
          </div>
          <div className="potential-box__one">
            <m.div
              initial={{ y: 100, opacity: 0 }}
              whileInView={{ y: 0, opacity: 1 }}
              transition={{ duration: 1, ease: "easeInOut", delay: 5 * animationDelay }}
              className="potential-box__item"
            >
            ...
            <m.div
              initial={{ y: 100, opacity: 0 }}
              whileInView={{ y: 0, opacity: 1 }}
              transition={{ duration: 1, ease: "easeInOut", delay: 6 * animationDelay }}
              className="potential-box__item"
            >
              <video
                className=""
              ...
              <div className="potential-box__item-content">
                ...
                <p>
                  Boost model performance with the latest <span>NVIDIA</span> accelerator, perfect for <span>GenAI and LLM</span> inference.
                </p>
              </div>
            </m.div>
          </div>
